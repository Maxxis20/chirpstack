...
export class DeviceKeys extends jspb.Message {
  ...
  getGenAppKey(): string;
  setGenAppKey(value: string): DeviceKeys;
...
export class ListDevicesRequest extends jspb.Message {
  ...
  getOrderBy(): ListDevicesRequest.OrderBy;
  setOrderBy(value: ListDevicesRequest.OrderBy): ListDevicesRequest;

  getOrderByDesc(): boolean;
  setOrderByDesc(value: boolean): ListDevicesRequest;

  getTagsMap(): jspb.Map<string, string>;
  clearTagsMap(): ListDevicesRequest;

  getDeviceProfileId(): string;
  setDeviceProfileId(value: string): ListDevicesRequest;
...
export namespace ListDevicesRequest {
  export type AsObject = {
    ...
    orderBy: ListDevicesRequest.OrderBy,
    orderByDesc: boolean,
    tagsMap: Array<[string, string]>,
    deviceProfileId: string,
  }
...
export class DeviceQueueItem extends jspb.Message {
  ...
  setExpiresAt(value?: google_protobuf_timestamp_pb.Timestamp): DeviceQueueItem;
  hasExpiresAt(): boolean;
  clearExpiresAt(): DeviceQueueItem;
...
export class EnqueueDeviceQueueItemRequest extends jspb.Message {
  ...
  getFlushQueue(): boolean;
  setFlushQueue(value: boolean): EnqueueDeviceQueueItemRequest;

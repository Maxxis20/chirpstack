...
import * as api_device_profile_pb from '../api/device_profile_pb'; // proto import: "api/device_profile.proto"
...
export class DeviceProfileTemplate extends jspb.Message {
  ...
  setClassBPingSlotPeriodicity(value: number): DeviceProfileTemplate;

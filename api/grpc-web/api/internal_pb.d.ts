...
import * as api_user_pb from '../api/user_pb'; // proto import: "api/user.proto"
...
export class SettingsResponse extends jspb.Message {
  ...
  setTileserverUrl(value: string): SettingsResponse;

  getMapAttribution(): string;
  setMapAttribution(value: string): SettingsResponse;

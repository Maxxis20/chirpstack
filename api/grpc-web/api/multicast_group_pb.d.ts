...
export class MulticastGroup extends jspb.Message {
  ...
  setClassBPingSlotPeriodicity(value: number): MulticastGroup;
...
export class MulticastGroupQueueItem extends jspb.Message {
  ...
  setExpiresAt(value?: google_protobuf_timestamp_pb.Timestamp): MulticastGroupQueueItem;
  hasExpiresAt(): boolean;
  clearExpiresAt(): MulticastGroupQueueItem;
